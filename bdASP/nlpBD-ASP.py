...
dataPath = os.path.join(__location__, "ocrASP-bd")
outPath = os.path.join(__location__, "outASP-bd")
if not os.path.isdir(os.path.join(outPath, "total")):
	os.mkdir(os.path.join(outPath, "total"))

if os.name == "nt":
	__location__
else:
	alertPath = "/media/bcadmin/wwwroot/eresources/UA_requests/alert-bdASP.txt"
